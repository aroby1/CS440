...
/* This record_class.h contains the class Records, which can be used to store tuples form Emp.csv (using EmpRecords structure) and Dept.csv (Using DeptRecords structure).*/
#include <bits/stdc++.h>
